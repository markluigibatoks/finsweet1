        ...
        <div class="mt-10 lg:mt-12 grid gap-8 grid-cols-1 lg:grid-cols-3">
          <div class="rounded-xl p-8 bg-gradient-light-blue-20 w-full">
            <div class="mb-7 flex gap-4 items-center">
              ...
              <div>
                <h5 class="text-[22px] font-medium leading-[28px] text-black">Breanna Parker</h5>
                <div class="mt-2 flex gap-2 items-center">
                  <div class="flex items-center justify-center">
                    <?php echo file_get_contents(get_template_directory() . '/assets/images/star.svg'); ?>
                  </div>
                  <div class="flex items-center justify-center">
                    <?php echo file_get_contents(get_template_directory() . '/assets/images/star.svg'); ?>
                  </div>
          ...
          <div class="rounded-xl p-8 bg-gradient-light-blue-20 w-full">
            <div class="mb-7 flex gap-4 items-center">
              ...
              <div>
                <h5 class="text-[22px] font-medium leading-[28px] text-black">Ana Oleynkova</h5>
                <div class="mt-2 flex gap-2 items-center">
                  <div class="flex items-center justify-center">
                    <?php echo file_get_contents(get_template_directory() . '/assets/images/star.svg'); ?>
                  </div>
          ...
          <div class="rounded-xl p-8 bg-gradient-light-blue-20 w-full">
            <div class="mb-7 flex gap-4 items-center">
              ...
              <div>
                <h5 class="text-[22px] font-medium leading-[28px] text-black">Andy Smith</h5>
                <div class="mt-2 flex gap-2 items-center">
                  <div class="flex items-center justify-center">
                    <?php echo file_get_contents(get_template_directory() . '/assets/images/star.svg'); ?>
                  </div>
